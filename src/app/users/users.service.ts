...
import { ResponseUsers, ResponseCreate, RequestCreate, ResponseUser, RequestUpdate, ResponseUpdate } from './users.model';
...
export class UsersService {
  ...
  getDados(id: string): Observable<ResponseUser> {
